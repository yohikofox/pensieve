...
describe('SyncAdminController', () => {
  ...
  describe('getStats', () => {
    ...
    it('should calculate percentiles correctly', async () => {
      const now = new Date();
      const mockLogs: Partial<SyncLog>[] = [
        { id: '1', userId: 'u1', syncType: 'pull', startedAt: now, completedAt: now, durationMs: 100, recordsSynced: 1, status: 'success', errorMessage: null },
        { id: '2', userId: 'u2', syncType: 'pull', startedAt: now, completedAt: now, durationMs: 200, recordsSynced: 1, status: 'success', errorMessage: null },
        { id: '3', userId: 'u3', syncType: 'pull', startedAt: now, completedAt: now, durationMs: 300, recordsSynced: 1, status: 'success', errorMessage: null },
        { id: '4', userId: 'u4', syncType: 'pull', startedAt: now, completedAt: now, durationMs: 400, recordsSynced: 1, status: 'success', errorMessage: null },
        { id: '5', userId: 'u5', syncType: 'pull', startedAt: now, completedAt: now, durationMs: 500, recordsSynced: 1, status: 'success', errorMessage: null },
        { id: '6', userId: 'u6', syncType: 'pull', startedAt: now, completedAt: now, durationMs: 600, recordsSynced: 1, status: 'success', errorMessage: null },
        { id: '7', userId: 'u7', syncType: 'pull', startedAt: now, completedAt: now, durationMs: 700, recordsSynced: 1, status: 'success', errorMessage: null },
        { id: '8', userId: 'u8', syncType: 'pull', startedAt: now, completedAt: now, durationMs: 800, recordsSynced: 1, status: 'success', errorMessage: null },
        { id: '9', userId: 'u9', syncType: 'pull', startedAt: now, completedAt: now, durationMs: 900, recordsSynced: 1, status: 'success', errorMessage: null },
        { id: '10', userId: 'u10', syncType: 'pull', startedAt: now, completedAt: now, durationMs: 1000, recordsSynced: 1, status: 'success', errorMessage: null },
      ];
    ...
    it('should group syncs by type (pull/push)', async () => {
      ...
      const mockLogs: Partial<SyncLog>[] = [
        { id: '1', userId: 'u1', syncType: 'pull', startedAt: now, completedAt: now, durationMs: 100, recordsSynced: 1, status: 'success', errorMessage: null },
        { id: '2', userId: 'u2', syncType: 'pull', startedAt: now, completedAt: now, durationMs: 100, recordsSynced: 1, status: 'success', errorMessage: null },
        { id: '3', userId: 'u3', syncType: 'pull', startedAt: now, completedAt: now, durationMs: 100, recordsSynced: 1, status: 'success', errorMessage: null },
        { id: '4', userId: 'u4', syncType: 'push', startedAt: now, completedAt: now, durationMs: 100, recordsSynced: 1, status: 'success', errorMessage: null },
        { id: '5', userId: 'u5', syncType: 'push', startedAt: now, completedAt: now, durationMs: 100, recordsSynced: 1, status: 'success', errorMessage: null },
      ];
